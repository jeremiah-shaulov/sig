<!--
	...
	deno run --allow-all https://raw.githubusercontent.com/jeremiah-shaulov/tsa/v0.0.57/tsa.ts doc-md --outFile=README.md --outUrl=https://raw.githubusercontent.com/jeremiah-shaulov/sig/0.0.10/README.md --importUrl=jsr:@shaulov/sig@0.0.10 mod.ts
-->
...
// curl 'https://raw.githubusercontent.com/jeremiah-shaulov/sig/0.0.10/README.md' | perl -ne 's/^> //; $y=$1 if /^```(.)?/; print $_ if $y&&$m; $m=$y&&$m+/<example-p9mn>/' > /tmp/example-p9mn.ts
// deno run --allow-net /tmp/example-p9mn.ts

import {sig} from 'jsr:@shaulov/sig@0.0.10';
...
```ts
import {sig, Sig} from 'jsr:@shaulov/sig@0.0.10';
...
```ts
import {type Sig, sig} from 'jsr:@shaulov/sig@0.0.10';
...
```ts
// To download and run this example:
// curl 'https://raw.githubusercontent.com/jeremiah-shaulov/sig/0.0.10/README.md' | perl -ne 's/^> //; $y=$1 if /^```(.)?/; print $_ if $y&&$m; $m=$y&&$m+/<example-65ya>/' > /tmp/example-65ya.ts
...
```ts
// To download and run this example:
// curl 'https://raw.githubusercontent.com/jeremiah-shaulov/sig/0.0.10/README.md' | perl -ne 's/^> //; $y=$1 if /^```(.)?/; print $_ if $y&&$m; $m=$y&&$m+/<example-pf4z>/' > /tmp/example-pf4z.ts
...
```ts
// To download and run this example:
// curl 'https://raw.githubusercontent.com/jeremiah-shaulov/sig/0.0.10/README.md' | perl -ne 's/^> //; $y=$1 if /^```(.)?/; print $_ if $y&&$m; $m=$y&&$m+/<example-ksv8>/' > /tmp/example-ksv8.ts
...
```ts
// To download and run this example:
// curl 'https://raw.githubusercontent.com/jeremiah-shaulov/sig/0.0.10/README.md' | perl -ne 's/^> //; $y=$1 if /^```(.)?/; print $_ if $y&&$m; $m=$y&&$m+/<example-rlut>/' > /tmp/example-rlut.ts
...
```ts
// To download and run this example:
// curl 'https://raw.githubusercontent.com/jeremiah-shaulov/sig/0.0.10/README.md' | perl -ne 's/^> //; $y=$1 if /^```(.)?/; print $_ if $y&&$m; $m=$y&&$m+/<example-ajdy>/' > /tmp/example-ajdy.ts
...
> `class` Sig\<T><br>
> {<br>
> &nbsp; &nbsp; 🔧 [constructor](generated-doc/class.Sig/README.md#-constructorcompvalue-valueorpromiset--compvaluet-defaultvalue-t-setvalue-setvaluet-cancelcomp-cancelcompt-iserrorsignal-boolean)(compValue: [ValueOrPromise](generated-doc/private.type.ValueOrPromise/README.md)\<T> | [CompValue](generated-doc/private.type.CompValue/README.md)\<T>, defaultValue: T, setValue?: [SetValue](generated-doc/private.type.SetValue/README.md)\<T>, cancelComp?: [CancelComp](generated-doc/private.type.CancelComp/README.md)\<T>, isErrorSignal?: `boolean`)<br>
